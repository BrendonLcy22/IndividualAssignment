...
public class Level5 extends AppCompatActivity {
    ...
    public View[] circleViews = new View[36];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayout5 = findViewById(R.id.linear_layout_5);
        linearLayout6 = findViewById(R.id.linear_layout_6);
...
//                        editor.commit();
        ...
        for (int i = 0; i < 36; i++) {
            ...
            if (i < 6) {
                ...
                linearLayout6.addView(circleView);
            }
